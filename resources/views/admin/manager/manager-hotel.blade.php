                    ...
                    <tr>
                        ...
                        <td style="display: flex">
                            <button  type="button" class="btn mr-lg-1 ml-lg-1 btn-warning edit-discount"
                                     data-toggle="modal" data-target="#edit-discount-show"><a style="color: #fff" href="{{route('get.edit-hotel',$item->id)}}"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a></button>
